...
go_bandit([](){
    describe("Basic JSON", [](){
        ...
        it("1.7. Reads in UTF8", [&](){
            ...
            json << j;
            AssertThat(json.str(), Equals(R"("\u16A0\u16C7\u16BB\u16EB\u16D2\u16E6\u16A6\u16EB\u16A0\u16B1\u16A9\u16A0\u16A2\u16B1\u16EB\u16A0\u16C1\u16B1\u16AA\u16EB\u16B7\u16D6\u16BB\u16B9\u16E6\u16DA\u16B3\u16A2\u16D7")"));
        });
        ...
        it("1.9. Reads in a map", [&](){
            JSON j(JMap{
                {"Lot 1", JMap{{"make", {"hillman"}}, {"model", {"Hunter"}},  {"year", {1974}}}},
                {"Lot 2", JMap{{"make", {"porsche"}}, {"model", {"Cayenne"}}, {"year", {1982}}}}
            });
            AssertThat(j.isNull(), Equals(false));
            ...
            json << j;
            AssertThat(json.str(), Equals(R"({"Lot 1":{"make":"hillman","model":"Hunter","year":1974},"Lot 2":{"make":"porsche","model":"Cayenne","year":1982}})"));
        });
    });
});
